...
// UNUSED EXPORTS: character, default, projectAgent, testSuites

;// external "@elizaos/core"
const core_namespaceObject = require("@elizaos/core");
;// external "crypto"
...
function rng() {
  if (poolPtr > rnds8Pool.length - 16) {
    (0,external_crypto_namespaceObject.randomFillSync)(rnds8Pool);
    poolPtr = 0;
  }
...
var native_default = { randomUUID: external_crypto_namespaceObject.randomUUID };
...
var initCharacter = ({ runtime }) => {
  core_namespaceObject.logger.info("Initializing character");
  core_namespaceObject.logger.info("Name: ", character.name);
};
var projectAgent = {
  character,
...
var index_default = (/* unused pure expression or super */ null && (project));
